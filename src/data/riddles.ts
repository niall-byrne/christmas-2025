...
export const riddles: RiddleType[] = [
  ...
  {
    answer: "turtle dove",
    hint: ["Which Christmas bird moves the slowest ?"],
    id: "1",
  },
  {
    answer: "frostbite",
    hint: ["What do you get when you mix a vampire with a snowman ?"],
    id: "2",
  },
  {
    answer: "santa",
  ...
  },
  {
    answer: "36",
    hint: [
      "I have just built a beautiful square gingerbread house, with a pointed triangle roof.",
      " ",
